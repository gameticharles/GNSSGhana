...
namespace org.gogpsproject.ephemeris
{
    ...
    public class EphQzs : Streamable
	{
...
//ORIGINAL LINE: public EphQzs(java.io.DataInputStream dai, boolean oldVersion) throws java.io.IOException
		public EphQzs(ObjectInputStream dai, bool oldVersion)
		{
			read(dai,oldVersion);
		}
