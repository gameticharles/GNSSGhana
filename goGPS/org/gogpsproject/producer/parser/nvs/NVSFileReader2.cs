...
namespace org.gogpsproject.producer.parser.nvs
{
	...
	//	private File file;
		...
		private static Dictionary<int?, EphGps> ephs = new Dictionary<int?, EphGps>();

		internal static bool gpsEnable = true; // enable GPS data reading
		internal static bool qzsEnable = true; // enable QZSS data reading
		internal static bool gloEnable = true; // enable GLONASS data reading
		internal static bool galEnable = true; // enable Galileo data reading
		internal static bool bdsEnable = true; // enable BeiDou data reading

		internal static bool?[] multiConstellation = new Nullable[] {gpsEnable, qzsEnable, gloEnable, galEnable, bdsEnable};
