...
namespace org.gogpsproject.producer.parser.ublox
{
	...
	public class UBXMessageType
	{
		...
		public UBXMessageType(int mclass, int msgtype)
		{
			getMsg(mclass, msgtype);
		}

		public UBXMessageType(string mclass, string msgtype)
		{
			getMsg(mclass, msgtype);
		}
