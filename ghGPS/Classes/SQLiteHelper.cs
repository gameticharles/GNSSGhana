...
namespace ghGPS.Classes
{
    ...
    public class EntryList
    {
        ...
        public void Add(string ColumnName, object Content)
        {
    ...
    public class Column : IEnumerable<ColumnProperties>
    {
        ...
        /// <param name="Name">Column or field name</param>
        /// <param name="DataType">Data type</param>
        /// <param name="NotNull">Is nullable</param>
        public void Add(string Name, ColType DataType, bool NotNull)
        {
            ColumnProperties ml = new ColumnProperties();
            ml.Name = Name;
            ml.DataType = DataType;
        ...
        public void Add(string Name, ColType DataType, bool NotNull, string ID)
        {
            ColumnProperties ml = new ColumnProperties();
            ml.Name = Name;            
            ml.DataType = DataType;
        ...
        /// <param name="DataType">Data type</param>
        /// <param name="NotNull">Is nullable</param>
        /// <param name="AutoIncrement">Is Auto incremental </param>
        /// <param name="PrimaryKey">Is the Field a Primary Key</param>
        public void Add(string Name, ColType DataType, bool NotNull, bool AutoIncrement, bool PrimaryKey)
        {
            ColumnProperties ml = new ColumnProperties();
            ml.Name = Name;
            if (AutoIncrement)
        ...
        /// <param name="AutoIncrement">Is Auto incremental </param>
        /// <param name="PrimaryKey">Is the Field a Primary Key</param>
        /// <param name="DefaultValue">Default value for the fied</param>
        public void Add(string Name, ColType DataType, bool NotNull, bool AutoIncrement, bool PrimaryKey, string DefaultValue)
        {
            ColumnProperties ml = new ColumnProperties();
    ...
    public class SQLiteHelper
    {
        ...
        public void CreateTable(string TableName, string[] ColumnNames, bool[] NotNull, DbType[] DbTypes)
        {
        ...
        public void RenameTable(string tableFrom, string tableTo)
        {
            ...
            {
                SetConnection();
                SQLiteCommand sqliteCommand = new SQLiteCommand(string.Format("ALTER TABLE `{0}` RENAME TO `{1}`;", tableFrom, tableTo), DataBaseConnnection);
        ...
        public void AttachDatabase(string Database, string Alias)
        {
            ...
            {
                SetConnection();
                SQLiteCommand sqliteCommand = new SQLiteCommand(string.Format("attach '{0}' as {1};", Database, Alias), DataBaseConnnection);
        ...
        public void DetachDatabase(string Alias)
        {
            ...
            {
                SetConnection();
                SQLiteCommand sqliteCommand = new SQLiteCommand(string.Format("detach {0};", Alias), DataBaseConnnection);
