...
namespace ghGPS.Classes
{
    ...
    public static class KnownFolders
    {
        ...
        public static string GetPath(SpecialKnownFolder knownFolder)
        {
        ...
        /// <exception cref="System.Runtime.InteropServices.ExternalException">Thrown if the path
        ///     could not be retrieved.</exception>
        public static string GetPath(SpecialKnownFolder knownFolder, bool defaultUser)
        {
        ...
        /// <exception cref="System.Runtime.InteropServices.ExternalException">Thrown if the path
        ///     could not be retrieved.</exception>
        public static string GetDefaultPath(SpecialKnownFolder knownFolder)
        {
        ...
        /// <exception cref="System.Runtime.InteropServices.ExternalException">Thrown if the path
        ///     could not be retrieved.</exception>
        public static string GetDefaultPath(SpecialKnownFolder knownFolder, bool defaultUser)
        {
        ...
        public static void Initialize(SpecialKnownFolder knownFolder)
        {
        ...
        /// <exception cref="System.Runtime.InteropServices.ExternalException">Thrown if the known
        ///     folder could not be initialized.</exception>
        public static void Initialize(SpecialKnownFolder knownFolder, bool defaultUser)
        {
        ...
        private static string GetPath(SpecialKnownFolder knownFolder, KnownFolderFlags flags,
            bool defaultUser)
        {
            IntPtr outPath;
    ...
    /// installed.
    /// </summary>
    public enum SpecialKnownFolder
    {
        /// <summary>
