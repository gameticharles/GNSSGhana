	...
	public class HorizontalDatum : Datum, IHorizontalDatum
	{
		...
		public static HorizontalDatum WGS72
		{
			get
			{
				...
				datum.Wgs84Parameters = new Wgs84ConversionInfo(0, 0, 4.5, 0, 0, 0.554, 0.219,0 ,0, 0);
				return datum;
			}
		}
		...
		public static HorizontalDatum ED50
		{
			get
			{
				return new HorizontalDatum(CoordinateSystems.Ellipsoid.International1924, new Wgs84ConversionInfo(-87, -98, -121, 0, 0, 0, 0, 0, 0, 0), DatumType.HD_Geocentric,
