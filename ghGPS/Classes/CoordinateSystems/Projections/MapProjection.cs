...
namespace ghGPS.Classes.CoordinateSystems.Projections
{
	...
	internal abstract class MapProjection : MathTransform, IProjection
	{
        ...
        static protected double GridScale(double e2, double latitude, double longitude, double LongOfOrigin, double scale)
        {
        ...
        static protected double Convergence(double latitude, double longitude, double LongOfOrigin)
        {
        ...
        /// <returns></returns>
        static protected double getLongZone(double longitude)
        {
            double longZone = 0;
            if (longitude < 0.0)
            {
