...
namespace ghGPS.Classes.CoordinateSystems
{
	...
	public class LinearUnit : Info, ILinearUnit
	{
        ...
        /// <summary>
		/// Returns the Gold Coast foot linear unit (1ft = 0.3047997101815088m).
		/// </summary>
		public static ILinearUnit GoldCoastFoot
        {
            get { return new LinearUnit(0.3047997101815088, "Gold Coast foot", "EPSG", 9004, "ft", "Ghana foot", "Used in Ghana"); }
        }
        /// <summary>
